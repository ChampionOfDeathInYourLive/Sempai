...
class FinalWin(QWidget):
    def __init__(self, exp, set_appear, initUI,show):
        super().__init__()
        self.set_appear()
        self.initUI()
        self.show()
    ...
    def initUI(self):
        self.workh_text = QLabel(txt_workbench + self.results())
        self.index_text = QLabel(txt_index +  str(self.index))
        self.layout_line = QVBoxLayout()
        self.layout_line.addWidget(self.index_text, alignment = Qt.AlignLeft)
        self.layout_line.addWidget(self.workh_text, alignment = Qt.AlignLeft)
    ...
    def results(self):
        ...
        if self.exp.age == 9 or self.exp.age == 10:
            ...
            if self.index < 19.5 and self.index >= 15.5:
                return txt_res2
            if self.index < 15.5 and self.index >= 12=0.5:
                return txt_res3
